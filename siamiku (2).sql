...
--
-- Host: localhost:8889
-- Waktu pembuatan: 22 Jan 2022 pada 07.41
-- Versi server: 5.7.32
-- Versi PHP: 7.4.12
...
(9, 6, 'Dr. Ahmad Dahlan', '2022-01-17 05:34:58', NULL),
(12, 7, 'Dr. Ahmad Dahlan', '2022-01-17 21:19:28', NULL),
(13, 7, 'Dr. Ahmad', '2022-01-17 21:19:28', NULL);
...
INSERT INTO `audit` (`id`, `name`, `purpose`, `audit_date`, `audit_area`, `audit_by`, `audit_leader`, `siklus_number`, `siklus_year`, `status`, `created_at`, `updated_at`, `fakultas_id`, `unit`, `code`, `template_code`, `status_publish`, `deleted_at`, `location`, `criteria`) VALUES
(6, 'template 1', 'Konfirmasi kelengkapan dokumen 9 kriteria APS 4.0', '2022-01-22 00:00:00', '9 kriteria APS 4.0', '5', '2', 1, 2022, 'On progress', '2022-01-17 05:34:58', NULL, 1, 'Fakultas', NULL, '2', 'Unpublish', NULL, 'Lokasi 1', '{\"1\":\"Kriteria\",\"2\":\"hoa\",\"3\":\"Kriteria Baru baru\"}'),
(7, 'PKBM BAGUS WANDIRA BAGUS WANDIRA', 'Konfirmasi kelengkapan dokumen 9 kriteria APS 4.0', '2022-01-18 00:00:00', '9 kriteria APS 4.0', '5', '2', 1, 2022, 'Waiting', '2022-01-17 21:19:28', NULL, 1, 'Fakultas', NULL, '3', 'Unpublish', NULL, 'Lokasi 1', '{\"2\":\"1\"}');

-- --------------------------------------------------------

--
-- Struktur dari tabel `audit_kelengkapan`
--

CREATE TABLE `audit_kelengkapan` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `audit_id` int(11) DEFAULT NULL,
  `answer_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data untuk tabel `audit_kelengkapan`
--

INSERT INTO `audit_kelengkapan` (`id`, `audit_id`, `answer_by`, `users_id`, `created_at`, `updated_at`) VALUES
(1, 6, 'Auditee', 5, '2022-01-22 00:38:20', NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `audit_kelengkapan_answer`
--

CREATE TABLE `audit_kelengkapan_answer` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `audit_kelengkapan` int(11) DEFAULT NULL,
...
--
-- Dumping data untuk tabel `audit_kelengkapan_answer`
--

INSERT INTO `audit_kelengkapan_answer` (`id`, `audit_kelengkapan`, `question_id`, `keterangan`, `file`, `action`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'Dokumen formal struktur organisasi dan tata kerja', 'uploads/2022-01/32816.pdf', 'on', '2022-01-22 00:39:50', NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `audit_perbaikan`
--

CREATE TABLE `audit_perbaikan` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `audit_id` smallint(6) DEFAULT NULL,
  `created_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cms_users_id` smallint(6) DEFAULT NULL,
...
(43, '2021-12-10 03:47:51', '2021-12-27 05:29:38', 'Riwayat', 'icon-files-empty2', 'riwayat', 0, 3),
(44, '2021-12-10 03:50:07', '2021-12-27 05:28:36', 'My Account', 'icon-user', 'akun', 0, 9),
(45, '2021-12-19 11:04:28', '2021-12-22 08:37:22', 'Fakultas', 'icon-cube3', 'fakultas', 50, 1),
(46, '2021-12-20 11:25:29', '2021-12-27 05:28:36', 'User Management', 'icon-users', '#', 0, 7),
...
(50, '2021-12-22 01:36:45', '2021-12-27 05:28:36', 'Master', 'icon-cube3', 'javascript:;', 0, 8),
...
(56, '2021-12-23 20:48:39', '2021-12-27 05:29:38', 'Penjadwalan', 'icon-calendar', 'penjadwalan', 0, 4),
(57, '2021-12-26 22:27:56', '2021-12-27 05:28:36', 'Audit Template', 'icon-folder-open', 'template', 0, 6),
(58, '2021-12-26 22:28:28', '2021-12-27 05:29:38', 'Rekapitulasi', 'icon-calendar', 'rekaputulasi', 0, 5);
...
INSERT INTO `master_template` (`id`, `name`, `unit`, `purpose`, `audit_area`, `criteria`, `created_at`, `updated_at`) VALUES
(2, 'Template Untuk 1', 'Fakultas', 'Konfirmasi kelengkapan dokumen 9 kriteria APS 4.0', '9 kriteria APS 4.0', '{\"1\":\"Kriteria Baru baru\",\"2\":\"Kriteria\"}', '2022-01-04 08:53:56', NULL),
(3, 'PKBM BAGUS WANDIRA BAGUS WANDIRA', 'Fakultas', 'Konfirmasi kelengkapan dokumen 9 kriteria APS 4.0', '9 kriteria APS 4.0', '[\"Kriteria Baru\",\"Kriteria Baru baru\"]', '2022-01-17 21:12:56', NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `master_template_category`
--

CREATE TABLE `master_template_category` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `master_template` smallint(6) DEFAULT NULL,
...
--
-- Dumping data untuk tabel `master_template_category`
--

INSERT INTO `master_template_category` (`id`, `master_template`, `main_category`, `category`, `ordering`, `created_at`, `updated_at`) VALUES
(32, 2, 'Kriteria 1: Visi, misi, tujuan, dan sasaran', 'kriteria', NULL, '2022-01-14 12:54:58', NULL),
(33, 2, 'Kriteria 2: Tata pamong, tata kelola, dan kerjasama', 'kriteria', NULL, '2022-01-14 13:13:37', NULL),
(34, 2, 'Kriteria 3: Tata pamong, tata kelola, dan kerjasama', 'kriteria', NULL, '2022-01-14 13:35:29', NULL),
(36, 2, 'Indikator capaian standar pendidikan', 'capaian', NULL, '2022-01-14 13:54:15', NULL),
(37, 2, 'Indikator capaian standar pendidikan Kedua dua', 'capaian', NULL, '2022-01-14 14:37:31', NULL),
(38, 3, 'Kriteria 1: Visi, misi, tujuan, dan sasaran', 'kriteria', NULL, '2022-01-17 21:13:04', NULL),
(39, 3, 'Indikator capaian standar pendidikan', 'capaian', NULL, '2022-01-17 21:13:45', NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `master_template_question`
--

CREATE TABLE `master_template_question` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `master_template_category` int(11) DEFAULT NULL,
  `ordering` int(11) DEFAULT NULL,
  `question` text COLLATE utf8mb4_unicode_ci,
  `keterangan` text COLLATE utf8mb4_unicode_ci,
  `capaian` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_answer` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data untuk tabel `master_template_question`
--

INSERT INTO `master_template_question` (`id`, `master_template_category`, `ordering`, `question`, `keterangan`, `capaian`, `type_answer`, `created_at`, `updated_at`) VALUES
(1, 32, 1, 'Dokumen formal struktur organisasi dan tata kerja (Dokumen struktur organisasi fakultas/program studi)', 'Dokumen formal struktur organisasi dan tata kerja (Dokumen struktur organisasi fakultas/program studi)', NULL, NULL, NULL, NULL),
(2, 33, 1, 'Dokumen formal struktur organisasi dan tata kerja (Dokumen struktur organisasi fakultas/program studi)', 'SK mengajar, SK pengangkatan dosen, SK tenaga kependidikan', NULL, NULL, NULL, NULL),
(3, 32, 1, 'Dokumen formal struktur organisasi dan tata kerja 1 2', 'Dokumen formal struktur organisasi dan tata kerja 1 1 2', NULL, NULL, NULL, NULL),
(4, 32, NULL, '(Dokumen struktur organisasi fakultas/program studi)', 'SK mengajar, SK pengangkatan dosen, SK tenaga kependidikan, usulan tenaga kependidikan', NULL, NULL, '2022-01-14 13:29:50', NULL),
(5, 33, NULL, 'Dokumen formal struktur organisasi dan tata kerja (Dokumen strukture)', 'SK mengajar, SK pengangkatan dosen, SK tenaga kependidikan, usulan tenaga kependidikan', NULL, NULL, '2022-01-14 13:29:58', NULL),
(6, 33, NULL, 'Dokumen formal struktur organisasi', 'SK mengajar, SK pengangkatan dosen, SK tenaga kependidikan, usulan tenaga kependidikan', NULL, NULL, '2022-01-14 13:35:14', NULL),
(7, 34, NULL, 'Dokumen saja', 'SK mengajar, SK pengangkatan dosen, SK tenaga kependidikan, usulan tenaga kependidikan', NULL, NULL, '2022-01-14 13:35:36', NULL),
(8, 34, NULL, 'Dokument 2', 'SK mengajar, SK pengangkatan dosen, SK tenaga kependidikan, usulan tenaga kependidikan', NULL, NULL, '2022-01-14 13:35:41', NULL),
(9, 34, NULL, 'Dokument 3', 'SK mengajar, SK pengangkatan dosen, SK tenaga kependidikan, usulan tenaga kependidikan', NULL, NULL, '2022-01-14 13:35:45', NULL),
(10, 36, NULL, 'Rasio pendaftaranss', 'Rasio jumlah pendaftar terhadap jumlah pendaftar yang lulus adalah 5', '5', NULL, '2022-01-14 13:35:45', NULL),
(11, 36, NULL, 'Jumlah mahasiswa asing', 'Jumlahs mahasiswa asing mininmal 1%', '1%', NULL, '2022-01-14 14:37:08', NULL),
(12, 37, NULL, 'Jumlah mahasiswa asing', 'Jumlah mahasiswa asing mininmal 1%', '10%', NULL, '2022-01-14 14:40:07', NULL),
(13, 38, NULL, 'SK pendirian fakultas / program studi', 'SK mengajar, SK pengangkatan dosen, SK tenaga kependidikan, usulan tenaga kependidikan', NULL, NULL, '2022-01-17 21:13:21', NULL),
(14, 38, NULL, 'Renstra fakultas', 'Renstra, dokumen pengangkatan dosen (kriteria umum dari univ)', NULL, NULL, '2022-01-17 21:13:34', NULL),
(15, 39, NULL, 'Rasio pendaftaran', 'Rasio jumlah pendaftar terhadap jumlah pendaftar yang lulus adalah 5', '2,63', NULL, '2022-01-17 21:14:54', NULL);
...
(18, '2021_12_30_144140_create_master_template', 8),
(19, '2021_12_31_123701_create_master_template_question', 8),
(20, '2021_12_31_124803_create_master_template_category', 8),
(21, '2022_01_17_115907_audit_add_field_location', 9),
(22, '2022_01_17_123221_audit_add_field_criteria', 10),
(23, '2022_01_17_192301_audit_kelengkapan_answer', 11),
(24, '2022_01_20_061535_audit_kelengkapan_answers_data', 12),
(25, '2022_01_21_180409_audit_temuan', 13),
(26, '2022_01_22_060626_audit_perbaikan', 14);
...
--
-- Indeks untuk tabel `audit_kelengkapan`
--
ALTER TABLE `audit_kelengkapan`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `audit_kelengkapan_answer`
--
ALTER TABLE `audit_kelengkapan_answer`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `audit_perbaikan`
--
ALTER TABLE `audit_perbaikan`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `audit_temuan`
--
...
--
-- Indeks untuk tabel `master_template_category`
--
ALTER TABLE `master_template_category`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `master_template_question`
--
ALTER TABLE `master_template_question`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `audit_kelengkapan`
--
ALTER TABLE `audit_kelengkapan`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `audit_kelengkapan_answer`
--
ALTER TABLE `audit_kelengkapan_answer`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `audit_perbaikan`
--
ALTER TABLE `audit_perbaikan`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `audit_temuan`
--
ALTER TABLE `audit_temuan`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `master_template_category`
--
ALTER TABLE `master_template_category`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT untuk tabel `master_template_question`
--
ALTER TABLE `master_template_question`

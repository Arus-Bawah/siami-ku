...
@section('content')
    <div class="card">
        <div class="card-body">
            <form id="formUpdate" action="{{ route('master.users.update', ['id' => $user_id]) }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" id="password" placeholder="******" class="form-control" minlength="5"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-bottom border-bottom-0 nav-justified">
                                        @if ($data->tanda_tangan != '')
                                            <li class="nav-item">
                                                <a href="#signatureExisting" :class="`nav-link ${form.signature_type == 'existing' ? 'active' : ''}`"
                                        ...
                                        @endif
                                        <li class="nav-item">
                                            <a href="#signatureUpload" :class="`nav-link ${form.signature_type == 'upload' ? 'active' : ''}`" data-toggle="tab"
                                                @click="changeSignatureType('upload')">
                                                Upload
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#signatureDraw" :class="`nav-link ${form.signature_type == 'draw' ? 'active' : ''}`" data-toggle="tab"
                                    ...
                                    <div class="tab-content">
                                        @if ($data->tanda_tangan != '')
                                            <div id="signatureExisting" :class="`tab-pane fade ${form.signature_type == 'existing' ? 'show active' : ''}`">
                                                <div class="row">
                                                    <div class="col-12 col-md-6 mr-auto ml-auto">
                                                        <a href="{{ url($data->tanda_tangan) }}" data-lightbox="image-1" data-title="Profile Signature"
                                                            data-lightbox="roadtrip">
                                                            <img src="{{ url($data->tanda_tangan) }}" class="img-fluid img-thumbnail"
                                        ...
                                        <div id="signatureUpload" :class="`tab-pane fade ${form.signature_type == 'upload' ? 'show active' : ''}`">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>
                                        ...
                                        <div id="signatureDraw" :class="`tab-pane fade ${form.signature_type == 'draw' ? 'show active' : ''}`">
                                            <div class="row">
                                                <div class="col">
                                                    <label>
                                                        Upload Tanda Tangan :
                                                ...
                                                <div class="form-check form-unit">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" class="form-check-input" name="unit[]" value="{{ $unit->id }}"
                                                            @click=isCheckSection @if (in_array($unit->id, $role)) checked @endif>
                                                        {{ $unit->unit }}
                                                    </label>
                                                </div>
                                            @endforeach

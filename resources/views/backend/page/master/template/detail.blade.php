        ...
        <div class="col-sm-12">
            <div class="card">
                <ul class="nav nav-tabs" style="background: #EAEAEA;">
                    <li class="nav-item"><a href="{{adminUrl('template/detail/'.$data->id)}}?type=kelengkapan&return_url={{g('return_url')}}" class="nav-link custom {{(g('type') != 'capaian' ?'active':'')}}">Pengecekan kelengkapan dokumen</a></li>
                    <li class="nav-item"><a href="{{adminUrl('template/detail/'.$data->id)}}?type=capaian&return_url={{g('return_url')}}" class="nav-link custom {{(g('type') == 'capaian' ?'active':'')}}">Capaian standar</a></li>
                </ul>
                <div class="card-body">
                    <div class="d-md-flex">

...
class AuditorController extends Controller
{
    ...
    public function getIndex()
    {
        ...
        $data['list'] = CmsUsersRepository::listData("Auditor");
        return view(adminView('user_manager.auditor.index'),$data);
    }
    public function getAdd()
    {
        $data['page_title'] = "Tambah Auditor";
        $data['data'] = new CmsUsers();
        return view(adminView('user_manager.auditor.form'),$data);
    }
    public function getEdit($id)
    {
        $data['page_title'] = "Edit Auditor";
        $data['data'] = CmsUsers::findById($id);
        return view(adminView('user_manager.auditor.form'),$data);
    }
    public function postSaveData()
    {
        $find = CmsPrivileges::findBy("name","Auditor");

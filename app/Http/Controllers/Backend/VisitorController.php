...
class VisitorController extends Controller
{
    ...
    public function getIndex()
    {
        ...
        $data['list'] = CmsUsersRepository::listData("Visitor");
        return view(adminView('user_manager.visitor.index'),$data);
    }
    public function getAdd()
    {
        $data['page_title'] = "Tambah Visitor";
        $data['data'] = new CmsUsers();
        return view(adminView('user_manager.visitor.form'),$data);
    }
    ...
    {
        $find = CmsPrivileges::findBy("name","Visitor");
